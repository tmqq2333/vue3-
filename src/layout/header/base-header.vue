...
export default defineComponent({
  ...
  components: { Logo,CollapseSidebarBtn,Breadcrumb,BaseSidebar,Expand,HeaderMixNavMenus},
  setup() {
    ...
    return { store, state,title, logo, ESidebarLayoutEnum };
  }
});
</script>
<template>
  <div class="rr-header-ctx">
    <div class="rr-header-ctx-logo hidden-xs-only">
      <logo :logoUrl="logo" :logoName="title"></logo>
    </div>
